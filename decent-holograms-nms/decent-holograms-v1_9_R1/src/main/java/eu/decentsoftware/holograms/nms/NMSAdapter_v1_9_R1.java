...
public class NMSAdapter_v1_9_R1 implements NMSAdapter {
	...
	static {
		DWO_ENTITY_DATA = R.getFieldValue(Entity.class, "ax");
		DWO_CUSTOM_NAME = R.getFieldValue(Entity.class, "az");
		DWO_CUSTOM_NAME_VISIBLE = R.getFieldValue(Entity.class, "aA");
		DWO_REMAINING_AIR = R.getFieldValue(Entity.class, "ay");
		DWO_IS_SILENT = R.getFieldValue(Entity.class, "aB");
