 ...
 * @since 3.0.0
 */
public interface HologramPositionManager {
     ...
     */
    void setLocation(@NonNull DecentLocation location);
    ...
    /**
     * Get the actual bukkit location of this hologram. This method returns the location of the
     * hologram with all offsets and animations applied.
     *
     * @return The actual bukkit location of this hologram.
     * @see #getActualLocation()
     * @throws IllegalStateException If the world of the location is not loaded.
     */
    @NonNull
    Location getActualBukkitLocation();
     ...
     */
    void setOffsets(@NonNull Vector offsets);
