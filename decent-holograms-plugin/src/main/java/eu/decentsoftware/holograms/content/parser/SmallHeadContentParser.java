...
import eu.decentsoftware.holograms.core.line.renderer.SmallHeadLineRenderer;
...
public class SmallHeadContentParser implements ContentParser {
    ...
    public SmallHeadContentParser(@NonNull DecentHolograms plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean parse(@NonNull CoreHologramLine line) {
        ...
        renderer = new SmallHeadLineRenderer(plugin, line, itemStack);
        line.setRenderer(renderer);
        line.setTypeYOffset(-1.1875d);
